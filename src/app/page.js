      ...
      <main className="bg-white dark:bg-gray-800">
        ...
        <section className="min-h-screen">
          ...
          <div className="text-center p-10 md:px-20 lg:px-40">
            ...
            <h3 className="text-xl mx-auto px-10 py-2 md:text-3xl text-black dark:text-white">Computer Engineering Student and Developer</h3>
            <p className="flex text-md px-10 py-5 leading-7 text-gray-800 md:text-xl max-w-lg mx-auto dark:text-gray-500">
